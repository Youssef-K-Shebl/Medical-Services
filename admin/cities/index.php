...
<div class="col-sm-12">
    ...
    <table class="table table-dark table-bordered">
        ...
        <tbody>
        <?php $data = getAllRows('cities'); $x=1;  ?>
        <?php foreach($data as $row){   ?>
            <tr class="text-center">
                ...
                <td class="text-center">
                    ...
                    <a href="<?php echo BURLA.'cities/delete.php?id='.$row['city_id'] ?>" class="btn btn-danger delete" data-field="city_id" data-id="<?php echo $row['city_id']; ?>" data-table="cities" >Delete</a>
                </td>
            </tr>
            <?php $x++; } ?>
